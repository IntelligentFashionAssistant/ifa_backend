...
class Data
{
    ...
    public static List<Garment> garments = new List<Garment>(){
        new Garment() { Id = 1,Name="A line Dress",Description="A line Dress",Brand="Lazorde",Price=66.5,CategoryId=2,StoreId=1},
        new Garment() { Id = 2,Name="Athletic Tank",Description="Sports Tank top",Brand="adidas",Price=15,CategoryId=5,StoreId=2},
        new Garment() { Id = 4,Name="Athletic Tank",Description="sport clothing",Brand="adidas",Price=17,CategoryId=5,StoreId=1},
        new Garment() { Id = 5,Name="Mesh Pleated Jersey Dress",Description="Mesh Pleated Jersey Dress",Brand="Coala",Price=19,CategoryId=2,StoreId=2},
        new Garment() { Id = 6,Name="Midi Bodycon dress",Description="Midi Bodycon dress",Brand="Havana",Price=55,CategoryId=2,StoreId=2},
        new Garment() { Id = 7,Name="Mesh Pleated Jersey Dress",Description="Mesh Pleated Jersey Dress",Brand="Coala",Price=43,CategoryId=2,StoreId=2},
        new Garment() { Id = 8,Name="Capri styled dress",Description="Capri styled dress",Brand="Mangos",Price=69.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 9,Name="assymetrical hem shirt",Description="assymetrical hem shirt",Brand="Mangos",Price=15,CategoryId=5,StoreId=2},
        new Garment() { Id = 10,Name="asymmetrical hem Top",Description="asymmetrical hem Top",Brand="Coala",Price=23,CategoryId=5,StoreId=2},
        new Garment() { Id = 11,Name="asymmetrical hem Shirt",Description="asymmetrical hem Shirt",Brand="Havana",Price=30,CategoryId=5,StoreId=1},
        new Garment() { Id = 12,Name="asymmetrical hem long shirt",Description="asymmetrical hem Top",Brand="Berchika",Price=37,CategoryId=5,StoreId=2},
        new Garment() { Id = 13,Name="asymmetrical hem Top",Description="Chiffon shirt",Brand="Coala",Price=20,CategoryId=5,StoreId=2},
        new Garment() { Id = 14,Name="asymmetrical hem Top",Description="asymmetrical hem shoulder straps",Brand="Havana",Price=15,CategoryId=5,StoreId=2},
        new Garment() { Id = 15,Name="asymmetrical hem Top",Description="asymmetrical hem Top",Brand="Mangos",Price=25,CategoryId=5,StoreId=2},
        new Garment() { Id = 16,Name="asymmetrical hem Top",Description="asymmetrical hem Top",Brand="Lazorde",Price=22,CategoryId=5,StoreId=2},
        new Garment() { Id = 17,Name="asymmetrical hem Top",Description="asymmetrical hem Top",Brand="Havana",Price=30,CategoryId=5,StoreId=1},
        new Garment() { Id = 18,Name="Bodycon Dress",Description="Bodycon Dress",Brand="Berchika",Price=39.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 19,Name="Bodycon Dress",Description="Bodycon Dress",Brand="Mangos",Price=39.99,CategoryId=2,StoreId=2},
        new Garment() { Id = 20,Name="Bodycon Dress",Description="Bodycon with flared waist dress",Brand="Coala",Price=64.99,CategoryId=2,StoreId=2},
        new Garment() { Id = 21,Name="Vertical camuflage ",Description="Vertical camuflage ",Brand="CarkoQ",Price=19.99,CategoryId=5,StoreId=2},
        new Garment() { Id = 22,Name="Chiffon sleeves ",Description="Chiffon sleeves ",Brand="Mangos",Price=29.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 23,Name="Belted waist dress",Description="Belted waist dress",Brand="Mangos",Price=49.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 24,Name="Belted Dress",Description="Belted Dress",Brand="Mangos",Price=19.99,CategoryId=2,StoreId=2},
        new Garment() { Id = 25,Name="Belted waist dress",Description="Belted waist dress",Brand="Chivara",Price=24.99,CategoryId=2,StoreId=2},
        new Garment() { Id = 26,Name="Brush Stroke",Description="Brush Stroke",Brand="Berchika",Price=19.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 27,Name="Button Up ",Description="Button Up ",Brand="Chivara",Price=14,CategoryId=5,StoreId=1},
        new Garment() { Id = 28,Name="Buttoned with bowtie",Description="Buttoned with bowtie",Brand="Havana",Price=13,CategoryId=5,StoreId=1},
        new Garment() { Id = 29,Name="Button Up with cinched waist",Description="Button Up with cinched waist",Brand="Coala",Price=19.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 30,Name="Draped Dress ",Description="Draped Dress ",Brand="Havana",Price=34.99,CategoryId=2,StoreId=2},
        new Garment() { Id = 31,Name="Gathered waistline Dress",Description="Gathered waistline Dress",Brand="Mangos",Price=19,CategoryId=2,StoreId=2},
        new Garment() { Id = 32,Name="Gathered waistline Dress",Description="Gathered waistline Dress",Brand="Sawsan Sweing ",Price=24,CategoryId=2,StoreId=1},
        new Garment() { Id = 33,Name="Gathered waistline Dress",Description="Gathered waistline Dress with bowtie",Brand="Sawsan Sweing ",Price=63,CategoryId=2,StoreId=1},
        new Garment() { Id = 34,Name="Crochet knitted ",Description="Crochet knitted ",Brand="Coala",Price=70,CategoryId=5,StoreId=1},
        new Garment() { Id = 35,Name="Short Bootcut pants",Description="Short Bootcut pants",Brand="Centerpoint ",Price=15,CategoryId=4,StoreId=1},
        new Garment() { Id = 36,Name="Crop pants",Description="Crop pants",Brand="Mangos",Price=12,CategoryId=4,StoreId=1},
        new Garment() { Id = 37,Name="Bootcut",Description="bootcut",Brand="Coala",Price=15,CategoryId=4,StoreId=1},
        new Garment() { Id = 38,Name="Diamond pattern dress",Description="Diamond pattern drop waist dress",Brand="Mangos",Price=22,CategoryId=2,StoreId=1},
        new Garment() { Id = 39,Name="Drop waist dress",Description="Drop waist dress",Brand="Mangos",Price=39.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 40,Name="Drop waist dress",Description="Drop waist dress",Brand="Coala",Price=30,CategoryId=2,StoreId=1},
        new Garment() { Id = 41,Name="Drop waist dress",Description="Drop waist dress",Brand="Havana",Price=29.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 42,Name="Drop waist dress",Description="Drop waist dress",Brand="Lazorde",Price=40,CategoryId=2,StoreId=2},
        new Garment() { Id = 43,Name="Bodycon Dress",Description="Bodycon Dress",Brand="Lazorde",Price=40,CategoryId=2,StoreId=1},
        new Garment() { Id = 44,Name="Bodycon Dress",Description="Bodycon Dress",Brand="Lazorde",Price=40,CategoryId=2,StoreId=2},
        new Garment() { Id = 45,Name="chiffon speckled top",Description="chiffon speckled top",Brand="Lora",Price=17,CategoryId=5,StoreId=2},
        new Garment() { Id = 46,Name="Front Draped top",Description="front Draped top",Brand="Berchika",Price=21.5,CategoryId=5,StoreId=2},
        new Garment() { Id = 47,Name="Front Draped top",Description="Front Draped top",Brand="Mangos",Price=20,CategoryId=5,StoreId=1},
        new Garment() { Id = 48,Name="Front Draped top",Description="Front Draped top",Brand="Coala",Price=29.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 49,Name="Front bowtie top",Description="Front bowtie top",Brand="Coala",Price=29,CategoryId=5,StoreId=1},
        new Garment() { Id = 50,Name="Drop waist dress",Description="Drop waist dress",Brand="Coala",Price=49.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 51,Name="Asymmetrical hem Dress",Description="Asymmetrical hem Dress",Brand="Mangos",Price=35,CategoryId=2,StoreId=1},
        new Garment() { Id = 52,Name="Mesh Pleated Jersey Dress",Description="Mesh Pleated Jersey Dress",Brand="Havana",Price=53,CategoryId=2,StoreId=1},
        new Garment() { Id = 53,Name="Front Draped Drop waist dress",Description="Front Draped Drop waist dress",Brand="Lazorde",Price=37,CategoryId=2,StoreId=1},
        new Garment() { Id = 54,Name="Chiffon speckled top",Description="chiffon speckled top",Brand="Berchika",Price=15,CategoryId=5,StoreId=2},
        new Garment() { Id = 55,Name="A line dress",Description="A line dress",Brand="Mangos",Price=44,CategoryId=2,StoreId=2},
        new Garment() { Id = 56,Name="Long Drop waist",Description="Long Drop waist",Brand="Mangos",Price=33,CategoryId=2,StoreId=2},
        new Garment() { Id = 57,Name="Drop waist dress",Description="Drop waist dress",Brand="Coala",Price=53,CategoryId=2,StoreId=1},
        new Garment() { Id = 58,Name="Chiffon speckled top",Description="Chiffon speckled top",Brand="Lazorde",Price=19.99,CategoryId=5,StoreId=2},
        new Garment() { Id = 59,Name="Turtleneck knit raglan",Description="Turtleneck knit raglan",Brand="Havana",Price=60,CategoryId=5,StoreId=1},
        new Garment() { Id = 60,Name="Maxi dress",Description="Maxi dress",Brand="Mangos",Price=26,CategoryId=2,StoreId=2},
        new Garment() { Id = 61,Name="Maxi dress",Description="Maxi dress",Brand="Mangos",Price=27,CategoryId=2,StoreId=2},
        new Garment() { Id = 62,Name="Off-Shoulder ",Description="Off-Shoulder ",Brand="Berchika",Price=22,CategoryId=5,StoreId=2},
        new Garment() { Id = 63,Name="Off-Shoulder ",Description="Off-Shoulder ",Brand="Havana",Price=19.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 64,Name="Off-Shoulder waist flounce",Description="Off-Shoulder waist flounce",Brand="Havana",Price=19.99,CategoryId=5,StoreId=2},
        new Garment() { Id = 65,Name="Off-Shoulder Bust flounce",Description="Off-Shoulder Bust flounce",Brand="Coala",Price=33,CategoryId=5,StoreId=2},
        new Garment() { Id = 66,Name="Two buttons Off-Shoulder ",Description="Two buttons Off-Shoulder ",Brand="Lazorde",Price=24,CategoryId=5,StoreId=1},
        new Garment() { Id = 67,Name="A line dress",Description="A line dress",Brand="Coala",Price=66,CategoryId=2,StoreId=2},
        new Garment() { Id = 68,Name="Asymmetrical hem Dress",Description="Asymmetrical hem Dress",Brand="Havana",Price=29.99,CategoryId=2,StoreId=1},
        new Garment() { Id = 69,Name="Batwing ",Description="Batwing ",Brand="Mangos",Price=24.99,CategoryId=5,StoreId=1},
        new Garment() { Id = 70,Name="southwestern-patterned jumbsuit",Description="southwestern-patterned jumbsuit with Wide legs",Brand="Mangos",Price=0,CategoryId=7,StoreId=1},
        new Garment() { Id = 71,Name="Bright Textured jumbsuit",Description="Bright Textured jumbsuit with waist belt",Brand="Havana",Price=22,CategoryId=7,StoreId=1},
        new Garment() { Id = 74,Name="reddish jumbsuit",Description="reddish jumbsuit with wide legs and belted",Brand="Havana",Price=37.99,CategoryId=7,StoreId=2},
        new Garment() { Id = 75,Name="Jumbsuit ",Description="strapless wide legged Jumbsuit ",Brand="Berchika",Price=36,CategoryId=7,StoreId=2},
        new Garment() { Id = 76,Name="JumbSuit ",Description="jumbsuit with waist detail and straps",Brand="Lazorde",Price=33,CategoryId=7,StoreId=2},
        new Garment() { Id = 77,Name="Jubmbsuit",Description="jumbsuit with waist belt detail and straps",Brand="Coala",Price=29.99,CategoryId=7,StoreId=2},
        new Garment() { Id = 78,Name="Jubmbsuit",Description="strapless jumbsuit with waist detail ",Brand="Havana",Price=26,CategoryId=7,StoreId=1},
        new Garment() { Id = 79,Name="Jubmbsuit",Description="jumbsuit with chinched waist and wide straps",Brand="Lazorde",Price=22,CategoryId=7,StoreId=1},
        new Garment() { Id = 82,Name="Jubmbsuit",Description="jumbsuit with chinched waist and straps",Brand="Lazorde",Price=44,CategoryId=7,StoreId=2},
        new Garment() { Id = 83,Name="Jubmbsuit",Description="strapless jumbsuit with high waist ",Brand="Coala",Price=33,CategoryId=7,StoreId=1},
        new Garment() { Id = 84,Name="peplum jumbsuit",Description="jumbsuit with peplum on bust and pockets",Brand="Havana",Price=29.99,CategoryId=7,StoreId=1},
        new Garment() { Id = 85,Name="Culottes jumbsuit",Description="Culottes style jumbsuit with back bow",Brand="Havana",Price=54,CategoryId=7,StoreId=1},
        new Garment() { Id = 86,Name="Jubmbsuit",Description="jumbsuit with chinched waist and straps",Brand="Mangos",Price=33,CategoryId=7,StoreId=1},
        new Garment() { Id = 87,Name="Jubmbsuit",Description="front bow tie jumbsuit with flared legs",Brand="Havana",Price=44,CategoryId=7,StoreId=1},
        new Garment() { Id = 89,Name="Jubmbsuit",Description="jumbsuit with pockets ",Brand="Lazorde",Price=33,CategoryId=7,StoreId=1},
        new Garment() { Id = 90,Name="Dolman sleeve top",Description="Dolman sleeve top     ",Brand="Havana",Price=20,CategoryId=5,StoreId=1},
        new Garment() { Id = 91,Name="patterned joggers",Description="patterned joggers with drawstring",Brand="Havana",Price=25,CategoryId=4,StoreId=1},
        new Garment() { Id = 92,Name="patterned joggers",Description="patterned joggers",Brand="Havana",Price=19.99,CategoryId=4,StoreId=2},
        new Garment() { Id = 93,Name="drawstring joggers",Description="high waist drawstring joggers",Brand="Lazorde",Price=20,CategoryId=4,StoreId=1},
        new Garment() { Id = 94,Name="drawstring joggers",Description="drawstring joggers",Brand="Coala",Price=20,CategoryId=4,StoreId=1},
        new Garment() { Id = 95,Name="drawstring joggers",Description="drawstring joggers",Brand="Mangos",Price=20,CategoryId=4,StoreId=1},
        new Garment() { Id = 96,Name="drawstring joggers",Description="drawstring joggers",Brand="Havana",Price=15,CategoryId=4,StoreId=1},
        new Garment() { Id = 97,Name="Print skirt",Description="Print skirt",Brand="Lookas",Price=22,CategoryId=1,StoreId=2},
        new Garment() { Id = 98,Name="Panelled skirt ",Description="Panelled skirt ",Brand="Lazorde",Price=40,CategoryId=1,StoreId=2},
        new Garment() { Id = 99,Name="Tall skirt",Description="Tall skirt",Brand="Havana",Price=22,CategoryId=1,StoreId=2},
        new Garment() { Id = 100,Name="Full skirt",Description="Full skirt",Brand="Havana",Price=33,CategoryId=1,StoreId=2},
        new Garment() { Id = 101,Name="wrap end skirt",Description="wrap end skirt",Brand="Havana",Price=37,CategoryId=1,StoreId=1},
        new Garment() { Id = 102,Name="full skirt",Description="full skirt",Brand="Coala",Price=22,CategoryId=1,StoreId=2},
        new Garment() { Id = 103,Name="pencil style skirt",Description="pencil style skirt",Brand="Havana",Price=33,CategoryId=1,StoreId=2},
        new Garment() { Id = 104,Name="full skirt",Description="Full skirt",Brand="Mangos",Price=41,CategoryId=1,StoreId=1},
        new Garment() { Id = 105,Name="pencil style skirt",Description="grey pencil style skirt",Brand="Lazorde",Price=53,CategoryId=1,StoreId=2},
        new Garment() { Id = 106,Name="Panelled skirt",Description="Panelled skirt ",Brand="Lookas",Price=42,CategoryId=1,StoreId=1},
        new Garment() { Id = 109,Name="A Line skirt",Description="A Line skirt with chiffon ",Brand="Berchika",Price=33,CategoryId=1,StoreId=2},
        new Garment() { Id = 110,Name="pencil style skirt",Description="pencil style skirt",Brand="Havana",Price=33,CategoryId=1,StoreId=2},
        new Garment() { Id = 111,Name="Full skirt",Description="Full skirt",Brand="Berchika",Price=22,CategoryId=1,StoreId=1},
        new Garment() { Id = 112,Name="pencil style skirt",Description="pencil style skirt",Brand="Mangos",Price=22,CategoryId=1,StoreId=1},
        new Garment() { Id = 113,Name="Light jeans",Description="Distressed jeans",Brand="Denims",Price=22,CategoryId=4,StoreId=1},
        new Garment() { Id = 114,Name="High Waist jeans",Description="High Waist straight fit jeans",Brand="Denims",Price=22,CategoryId=4,StoreId=2},
        new Garment() { Id = 115,Name="Light jeans",Description="Distressed jeans",Brand="Denims",Price=22,CategoryId=4,StoreId=1},
        new Garment() { Id = 116,Name="Dark blue jeans",Description="Dark blue jeans",Brand="Denims",Price=33,CategoryId=4,StoreId=2},
        new Garment() { Id = 117,Name="High Waist jeans",Description="blended blue jeans",Brand="Denims",Price=22,CategoryId=4,StoreId=1},
        new Garment() { Id = 118,Name="Light jeans",Description="Light jeans",Brand="Denims",Price=22,CategoryId=4,StoreId=1},
        new Garment() { Id = 119,Name="Light jeans",Description="High waist skinny jeans",Brand="Denims",Price=33,CategoryId=4,StoreId=1},
        new Garment() { Id = 120,Name="Light jeans",Description="Low waist distressed jeans",Brand="Denims",Price=33,CategoryId=4,StoreId=2},
        new Garment() { Id = 121,Name="blended grey black jeans",Description="blended grey black jeans with cuffed hem and low waist",Brand="Denims",Price=37.99,CategoryId=4,StoreId=2},
        new Garment() { Id = 122,Name="Boyfriend jeans",Description="Boyfriend jeans ",Brand="Denims",Price=33,CategoryId=4,StoreId=1},
        new Garment() { Id = 123,Name="Cuffed Hem",Description="Dark blue jeans with cuffed hem",Brand="Denims",Price=22,CategoryId=4,StoreId=1},
        new Garment() { Id = 124,Name="Skinny jeans",Description="light blue Skinny jeans",Brand="Denims",Price=44,CategoryId=4,StoreId=2},
        new Garment() { Id = 125,Name="Distressed jeans",Description="Distressed jeans",Brand="Denims",Price=44,CategoryId=4,StoreId=2},
        new Garment() { Id = 126,Name="Distressed jeans",Description="Distressed light jeans",Brand="Denims",Price=33,CategoryId=4,StoreId=2},
        new Garment() { Id = 127,Name="Boyfriend jeans",Description="Boyfriend jeans",Brand="Denims",Price=24.99,CategoryId=4,StoreId=2},
        new Garment() { Id = 128,Name="Distressed jeans",Description="Distressed light jeans",Brand="Mangos",Price=22,CategoryId=4,StoreId=2},
        new Garment() { Id = 129,Name="Distressed jeans",Description="Distressed light jeans WITH cuffed hems",Brand="Denims",Price=33,CategoryId=4,StoreId=2},
        new Garment() { Id = 130,Name="Boyfriend jeans",Description="Boyfriend jeans",Brand="Denims",Price=29.99,CategoryId=4,StoreId=1},
        new Garment() { Id = 131,Name="Distressed jeans",Description="Distressed jeans with cuffed hems",Brand="Denims",Price=33,CategoryId=4,StoreId=2},
        new Garment() { Id = 132,Name="Boyfriend jeans",Description="MOM JEANS",Brand="Denims",Price=22,CategoryId=4,StoreId=2},
        new Garment() { Id = 133,Name="Slacks ",Description="chinched ends slacks",Brand="Mangos",Price=17,CategoryId=4,StoreId=1},
        new Garment() { Id = 134,Name="A Line Jeans skirt",Description="A Line Jeans skirt from denim",Brand="Denims",Price=39.99,CategoryId=1,StoreId=2},
        new Garment() { Id = 135,Name="pencil style jeans skirt ",Description="pencil style jeans skirt from denim",Brand="Denims",Price=19.99,CategoryId=1,StoreId=2},
        new Garment() { Id = 136,Name="Acid wash jeans",Description="Acid wash jeans",Brand="Denims",Price=29.99,CategoryId=4,StoreId=2},
        new Garment() { Id = 137,Name="Skinny jeans",Description="Skinny jeans",Brand="Denims",Price=30,CategoryId=4,StoreId=1},
        new Garment() { Id = 138,Name="Full skirt",Description="White Full skirt",Brand="Berchika",Price=50,CategoryId=1,StoreId=1},
        new Garment() { Id = 139,Name="Full skirt",Description="Golden full skirt",Brand="Sawsan Sweing ",Price=59.99,CategoryId=1,StoreId=1},
        new Garment() { Id = 140,Name="M slit Dress",Description="M slit Dress",Brand="Havana",Price=77,CategoryId=2,StoreId=1},
        new Garment() { Id = 141,Name="Dark skinny jeans",Description="Dark skinny jeans",Brand="Denims",Price=29.99,CategoryId=4,StoreId=1},
    };
